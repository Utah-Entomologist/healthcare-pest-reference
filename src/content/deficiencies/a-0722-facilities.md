...
governing_authorities:
  ...
  - slug: nacmcf-1997-haccp-prerequisite
    why: "If the kitchen runs a HACCP plan, pest control is a named prerequisite program the surveyor can ask to see."
  - slug: cdc-hicpac-environmental-guidelines
    why: "Names kitchens and cafeterias first among the high-risk areas a pest control strategy must emphasize."
...
- Receiving inspection records for food and supply deliveries
...
- Pest control in dietary is documented as a service contract but not as a program: no thresholds, no receiving inspection, no harborage work
- The dietary staff observe activity but there is no route from the kitchen to the pest vendor, so nothing happens until the next scheduled visit
- The kitchen's HACCP binder lists pest control as a prerequisite program but the supporting records are years old
- Structural harborage (drains, junctions, equipment gaps) is treated as the vendor's problem instead of a facilities work order
