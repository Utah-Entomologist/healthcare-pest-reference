...
summary: "The only explicit pest control mandate in the CMS long-term care requirements: the facility must maintain an effective pest control program so that it is free of pests and rodents. CMS defines the program and names the pests. Verbatim from Appendix PP Rev. 232."
regime: "CMS"
...
governing_authorities:
  ...
  - slug: fda-food-code-2022
    why: "The F812 kitchen-sanitation probe that routes to F925 looks for the same conditions the state-adopted Food Code’s pest section (6-501.111) requires a kitchen to control."
