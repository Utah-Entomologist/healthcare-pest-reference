...
seo_title: "A-0747 (42 CFR §482.42): The Infection Prevention and Control Condition — Verbatim CMS Text and How a Hospital Pest Finding Reaches It"
meta_description: "A-0747 is the condition-level CMS hospital survey tag for 42 CFR §482.42, Infection Prevention and Control and Antibiotic Stewardship Programs. Verbatim condition text, Interpretive Guidelines, and Survey Procedures from Appendix A Rev. 238 (03-20-2026). No pest language in the condition or the manual; how a pest finding framed as infection control is cross-referenced here from A-0750."
summary: "The condition-level tag for §482.42. Cross-referenced when pest activity is framed as an infection control failure rather than, or in addition to, a physical environment failure. Verified in Rev. 238."
regime: "CMS"
citation: "42 CFR §482.42, cited on Form CMS-2567 under A-0747 per CMS State Operations Manual, Appendix A (Rev. 238; Issued 03-20-26; Effective 09-05-25)"
...
verification_note: "Confirmed against the full text of Appendix A Rev. 238 (Issued 03-20-26; 613 pages; MD5 cf26c249b3c544aaecf7e130bfc1a1d6) on September 11, 2026, read from the reference's primary-source archive. Condition text matched against 42 CFR §482.42 in the eCFR XML of Part 482 (point-in-time 2026-09-08)."
...
governing_authorities:
  ...
  - slug: cms-state-operations-manual
    why: "The surveyor manual whose sanitary-environment guidance sits under the §482.42 tags, and which contains no pest guidance."
  - slug: cdc-hicpac-environmental-guidelines
    why: "The nationally recognized infection prevention guideline the condition requires adherence to; its pest recommendations define what an adequate program contains."
...
The standards beneath the condition are tagged separately: the program's organization and policies at A-0748 through A-0751 (§482.42(a)(1) through (a)(4)), including [A-0749](/deficiencies/a-0749-infection-prevention-and-control-program/) (methods for preventing and controlling transmission) and [A-0750](/deficiencies/a-0750-sanitary-environment/) (clean and sanitary environment); antibiotic stewardship from A-0760 (§482.42(b)); leadership responsibilities; unified programs for multi-hospital systems; and respiratory illness reporting.
...
A condition-level citation is a judgment that the deficiencies under the standards, taken together, mean the condition is not met. For a pest matter that means a pattern: pest activity in a sterile processing area, an operating room, a pharmacy, a laboratory, a food service area, or an area housing immunocompromised patients, combined with evidence that the infection prevention and control program was not aware of, not monitoring, or not engaged in pest events in the building. The standard-level finding is usually written first at [A-0750](/deficiencies/a-0750-sanitary-environment/) and cross-referenced here.
