...
governing_authorities:
  ...
  - slug: epa-ipm-toolkit-2021
    why: "The chemical-control-last hierarchy that determines how many pesticide containers should be on the shelf at all."
  - slug: utah-r68-7-pesticide-applicator
    why: "An example of the state applicator and storage rules that apply to whoever brought the product on site."
...
Carried from the authority pages: uninventoried pesticide containers, missing SDS, expired products on the shelf, improper segregation, missing secondary containment, and SDS access barriers on non-day shifts. The most common root cause is a contracted vendor leaving product on site that the hospital's hazard communication program does not know about.
