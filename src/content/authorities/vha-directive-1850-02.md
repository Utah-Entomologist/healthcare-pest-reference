---
title: "VHA Directive 1850.02 — Pest Management Operations Program"
seo_title: "VHA Directive 1850.02, Pest Management Operations Program (December 22, 2022): Verbatim Policy, Pest Management Officer, IPMOP Requirements, Prior Approval in Patient Care Areas, Training, and Recertification by December 2027"
...
facility_types_applicable:
  - VA medical facility
  - community-based outpatient clinic (VA)
  - outpatient center and health care center (VA)
...
summary: "The most prescriptive federal healthcare pest standard: every VA medical facility must implement an IPM program under a written Integrated Pest Management Operations Plan, designate a Pest Management Officer, respond to sightings within 48 hours, review records quarterly, and give prior approval before any pesticide application in patient care or restricted areas. Recertification due by the last working day of December 2027."
related_authorities:
  - slug: epa-ipm-toolkit-2021
    why: "The federal civilian IPM framework the directive parallels; the directive's own definition of IPM is quoted on this page."
  - slug: osha-hazard-communication
    why: "The directive requires Safety Data Sheets for every pesticide used and a labeled, ventilated storage area; the HazCom standard is the federal rule those requirements track."
  - slug: cdc-hicpac-environmental-guidelines
    why: "The environmental infection control guideline VA infection prevention programs reference; the directive's policy statement names disease vectors as the first concern."
  - slug: cms-conditions-of-participation
    why: "The hospital-side federal contrast: the Medicare condition has no pest language, while the VA directive prescribes a program in detail."
  - slug: fda-food-code-2022
    why: "The directive's IPMOP governs the whole facility, including food service; the Food Code's pest section is the civilian standard for the same kitchen."
---
...
> 5. RECERTIFICATION: This Veterans Health Administration (VHA) directive is scheduled for recertification on or before the last working day of December 2027. This VHA directive will continue to serve as national VHA policy until it is recertified or rescinded.
...
> (4) Selection of chemical and non-chemical options.
> (5) Procedures for reporting pest sighting and follow-up activities.
> (6) Staff and patient education.
> (7) Bed bug management. [...]
> (8) Safe use, storage and management of pesticides, including:
> (a) Ensuring that VA medical facility PMPs are provided appropriate PPE (consult pesticide label, SDS) and seek professional guidance from the safety office to determine appropriate PPE.
> (b) Ensuring that SDSs are readily available for all pesticides used at the VA medical facility.
> (c) Ensuring that all equipment used in pest control activities is marked "Contaminated with Pesticides."
> (d) Ensuring that there is a current inventory of pesticides stored at the VA medical facility.
> (e) Ensuring that the pesticide storage area is properly labeled on the entrance door, ventilated, provided adequate lighting and equipped with a spill kit.
> (9) Recordkeeping.
> (10) The ban on 2,4-D throughout VHA due to a perception by Veterans regarding the relationship between 2,4-D, Dioxin and Agent Orange.
> (11) The prohibition against feeding wildlife on VHA property. [...]
> (12) Training requirements for individuals to safely and appropriately use general use pesticides.
...
- The written IPMOP, one document, addressing the twelve subjects in paragraph 4.c, with evidence of annual review by the PMO
- The Director's written designation of the PMO
- The IPMOP pest management log showing sightings, the 48-hour response, and the corrective action reported back
- The PMO's quarterly review of all pest management documentation and trend tracking
- The PMO's prior approvals for applications in patient care and restricted areas
- PMP licensure and certification in Public Health Pest Control and other applicable categories; contractor licensure, insurance, and SDSs under the contract scope
- PMO training: a current applicator license or completion of the TMS curriculum VHA-198 on assignment and every two years
- Documented general awareness training for anyone applying general-use pesticides
- Current pesticide inventory, SDS access, and the storage area's labeling, ventilation, lighting, and spill kit
- PMP medical surveillance on employment and annually
- Records managed under VHA Records Control Schedule 10-1
...
VA facilities are reviewed internally under this directive rather than by CMS tag. Where a VA facility is also surveyed by The Joint Commission, or where a reader is comparing the directive to the civilian standards, the same observation is written to the identifiers covered in this reference's [survey deficiencies section](/deficiencies/): [A-0701](/deficiencies/a-0701-buildings/) and [A-0750](/deficiencies/a-0750-sanitary-environment/) for hospitals under CMS, [F925](/deficiencies/f925/) for nursing homes (the VA's community living centers are the VA equivalent), [§485.725(e)](/authorities/485-725e-pest-control/) for outpatient rehabilitation providers, and [PE.01.01.01](/deficiencies/pe-01-01-01-safe-adequate-environment/) under The Joint Commission. For a facility that does not know which identifier applies, see [Which tag is pest control?](/deficiencies/which-tag-is-pest-control/). The directive's sighting log, 48-hour response, quarterly review, and prior-approval records are, in practice, the documentation those citations ask for.
...
- **"The directive requires pesticide application records to be kept for three years."** Disconfirmed. The directive contains no retention period; paragraph 6 assigns records management to the NARA-approved schedules in VHA Records Control Schedule 10-1. (This claim appeared on this page until September 11, 2026.)
- **"The directive supersedes VHA Directive 7715 and VHA Handbook 7715 of September 24, 2010."** Not supported by the directive. Its rescission paragraph names VHA Directive 1850.02(1), Pest Management Operations, dated April 6, 2017. (This claim appeared on this page until September 11, 2026.)
- **"The directive names a 'Pesticide Manager Officer.'"** Disconfirmed. The role is the Pest Management Officer (PMO), the chief of the service under which the IPM program falls. (This claim appeared on this page until September 11, 2026.)
