---
title: "Utah Administrative Code R68-7 — Pesticide Applicator Licensing in Jails and Prisons"
...
facility_types_applicable:
  - county jail
  - state prison
  - other Utah correctional facility
services_applicable:
...
summary: "Utah’s pesticide applicator licensure rule. Its Category 7 definition names prisons expressly, and it sets the nine-element application record every commercial applicator must keep."
related_authorities:
  - slug: osha-1910-141-sanitation
    why: "The workplace rule that requires a continuing extermination program once vermin are detected; R68-7 governs who may carry it out."
  - slug: fda-food-code-2022
    why: "When Section 6-501.111(C) calls for pest control methods in a kitchen, R68-7 governs who may apply them in Utah."
  - slug: ice-nds-2019-food-service
    why: "The detention standard that assigns food service pest control to the facility."
---
...
- **Category 7 — Structural and Health Related Pest Control:** applicators applying pesticides in, on, or around structures the rule lists, which include a **prison**, and "any other structure or area"; includes vertebrate pests in and within three feet of structures. Excludes Fumigation (13) and Wood Destroying Organisms (15).
- **Category 8 — Public Health Pest Control:** limited to applicators managing pests "due to issues of medical and public health importance." The commercial branch is valid **only while the applicator is actively contracted by a government entity**; the non-commercial branch is limited to government employees in government-sponsored public health programs.
...
- Verification of the applicator's current Utah commercial license with the certification categories that match the scope of work (Category 7 for structural work; Category 12 for outdoor vertebrate work beyond three feet; Category 15 for wood-destroying organisms)
...
- Documentation of the verification in the contractor file
...
- **"UDAF's Category 7 definition names 'institutions such as schools, hospitals.'"** Disconfirmed on September 12, 2026. R68-7-7(7) says "dwelling, educational institution, or medical institution." The phrase "institutions such as schools, hospitals" does not appear in R68-7.
