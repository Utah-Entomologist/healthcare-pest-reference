---
title: "42 CFR §485.725(e) — Standard: Pest Control (Clinics, Rehabilitation Agencies, and Public Health Agencies)"
seo_title: "42 CFR §485.725(e) Standard: Pest Control — The Overlooked Federal Pest Control Standard for Clinics, Rehabilitation Agencies, and Public Health Agencies (Not Hospitals, Not Critical Access Hospitals)"
meta_description: "42 CFR §485.725(e) reads: “Standard: Pest control. The organization’s premises are maintained free from insects and rodents through operation of a pest-control program.” It sits in Part 485 Subpart H and binds clinics, rehabilitation agencies, and public health agencies as providers of outpatient physical therapy and speech-language pathology services. It does not apply to hospitals or to critical access hospitals. Verbatim text, the facility classes covered, the exclusions, and the contrast with the hospital side, where no explicit pest standard exists."
summary: "The explicit federal pest control standard for clinics, rehabilitation agencies, and public health agencies furnishing outpatient physical therapy and speech-language pathology services. Part 485 Subpart H, not the critical access hospital subpart. Hospitals and critical access hospitals have no equivalent."
authority_type: "federal regulator"
citation: "42 CFR §485.725(e), Part 485, Subpart H — Conditions of Participation for Clinics, Rehabilitation Agencies, and Public Health Agencies as Providers of Outpatient Physical Therapy and Speech-Language Pathology Services"
last_verified: 2026-09-11
date_published: 2026-09-11
source_url: "https://www.ecfr.gov/current/title-42/chapter-IV/subchapter-G/part-485/subpart-H/section-485.725"
source_tier: 1
source_confidence: "HIGH"
paywalled: false
facility_types_applicable:
  - clinic (outpatient physical therapy or speech-language pathology provider)
...
related_authorities:
  - slug: cms-conditions-of-participation
    why: "The hospital condition, §482.41, for contrast: it has no pest language, and neither does the hospital surveyor manual. Part 485 Subpart H is where the explicit federal standard actually is."
  - slug: cms-state-operations-manual
    why: "The hospital surveyor manual, with zero occurrences of pest, vermin, rodent, insect, or infestation; the reason a hospital cannot cite this standard."
  - slug: cdc-hicpac-environmental-guidelines
    why: "The standard of care that defines what “operation of a pest-control program” looks like, since the regulation itself specifies no method."
  - slug: epa-ipm-toolkit-2021
    why: "The federal program structure an organization can use to show a pest-control program is in operation."
  - slug: vha-directive-1850-02
    why: "The other explicit federal pest program mandate in healthcare, for the VA system; the two are the federal pair."
  - slug: fda-food-code-2022
    why: "Where a clinic or agency has any food service, the state-adopted Food Code’s pest section applies to that area in addition to this standard."
---
...
CMS's surveyor guidance appendix for Subpart H organizations, with its tag numbering and interpretive guidance for §485.725(e), was not in the verified source set for this page and is not characterized here: <span class="content-pending">[CONTENT PENDING — SUBPART H SURVEYOR APPENDIX NOT IN THE VERIFIED SOURCE SET]</span>. What can be said from the regulation alone is that the standard has two testable parts, the condition of the premises and the existence and operation of a program, and that a surveyor can fail either.
