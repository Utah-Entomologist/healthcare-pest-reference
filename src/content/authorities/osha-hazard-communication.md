---
title: "OSHA Hazard Communication Standard — Pesticide Storage and SDS Requirements"
...
related_authorities:
  ...
  - slug: utah-r68-7-pesticide-applicator
    why: "An example of the state applicator licensure and storage rules that overlay HazCom for whoever applies the products."
  - slug: usda-7cfr110-rescission
    why: "Why restricted-use pesticide application records now come from state rules rather than the rescinded federal Part 110."
  - slug: dnv-gl-niaho-standards
    why: "The DNV hazardous materials requirements that reference HazCom for DNV-accredited hospitals."
---
...
## Pesticide Storage Specifically

HazCom is the documentation standard, but a pesticide storage finding usually involves the EPA label, the eyewash requirement in 29 CFR 1910.151(c), state applicator rules, and the accreditor standard the finding is written to. Those are brought together on the [pesticide storage requirements for healthcare facilities](/topics/pesticide-storage-requirements-healthcare-facilities/) topic page.
