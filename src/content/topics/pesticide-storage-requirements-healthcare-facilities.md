...
governing_authorities:
  ...
  - slug: utah-r68-7-pesticide-applicator
    why: "An example of the state rules that govern who may apply what, and that carry their own storage and labeling requirements."
  - slug: usp-797-sterile-compounding
    why: "Pharmacy compounding areas, where pesticide storage and application are effectively excluded by the environmental standard."
---
...
- An SDS exists for every pesticide visible in the storage room
- The SDS file is accessible to staff on the shift being surveyed
- Container labels match SDS records
...
- Written Hazard Communication Program (one per workplace)
- Master pesticide inventory listing every product on hand: product name, EPA registration number, active ingredient, signal word, restricted-use designation, container size, quantity, storage location, expiration date, date received, date opened
- Safety Data Sheet for every product on the inventory
- SDS access points, physical and electronic, tested on every shift including nights and weekends
- Hazard communication training records for all staff with potential exposure
- Annual review attestation by the facility's Safety Officer
- For contracted service: a contract term that no product is left on site without being added to the inventory and SDS file
